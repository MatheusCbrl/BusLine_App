...
export default class App extends React.Component {
  ...
  async componentDidMount() {
    ...
    return fetch(
      'https://gist.githubusercontent.com/MatheusCbrl/24276c1191ae1c7b4f522110ffbb6341/raw/2ce37d70a889397aeb3c1e897e5d2bce0dc8a6d9/ParadasTerceiroTurno.json'
    )
      ...
      <View style={styles.container} {...this.props}>
        ...
        <View>
          ...
          <TouchableOpacity style={styles.fab6}>
            <Image
              source={require('../assets/3turno.png')}
              resizeMode="contain"
              style={{
                height: 40,
                width: 80,
