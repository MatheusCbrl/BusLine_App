...
const markers = require('./noturno json/São Lucas-Desvio Rizzo-Vila Romana-Santa Tereza-Conceição-Pedreira do Guerra.json');
              ...
              <View style={styles.card} key={id}>
                <View style={styles.textContent}>
                  ...
                  <Text numberOfLines={1} style={styles.text1}>
                    Clique no Ponto para mais informações
                  </Text>
                  <Image
